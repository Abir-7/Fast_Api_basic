...
def create_token(payload: Dict[str, Union[str, int]], token_type: str = TokenType.ACCESS) -> str:
    """
...
def create_access_refresh_tokens(payload: JwtPayload) -> AccessRefreshToken:
    """
